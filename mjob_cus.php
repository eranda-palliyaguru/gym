  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
		...
		<form method="post" action="save_cus_jobm.php">
...
<div class="form-group">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
				...
				<input type="hidden" name="vehicle_no" value="<?php echo $_GET['id']; ?>"  class="form-control"  >
                  </div>
                  </div>
				</div>
          ...
          <div class="row">
            <div class="col-md-6">
			   ...
			   <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone_no2" data-inputmask='"mask": "(999)-9999999"' data-mask>
                  </div>
                  </div>
			  </div>
	...
	<div class="form-group">
                  <div class="radio">
                    <label>
                      <input type="radio" name="pro" id="optionsRadios1" value="1" checked>
                      <i class="fa fa-key"></i>
                    </label>
                  </div>
		<div class="radio">
                    <label>
                      <input type="radio" name="pro" id="optionsRadios2" value="2" >
                      5%
                    </label>
                  </div>
		<div class="radio">
                    <label>
                      <input type="radio" name="pro" id="optionsRadios1" value="3" >
                      <i class="fa fa-leaf"></i> echo test
                    </label>
                  </div>
