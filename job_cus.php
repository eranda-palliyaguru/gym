...
<div class="form-group">
	...
	<div class="box-body">
      ...
      <div class="box-body">
	     ...
	     <input type="hidden" name="engine_no" class="form-control pull-right"  >
					 <input type="hidden" name="chassis_no" class="form-control pull-right"  >	
	
	     <input type="hidden" name="bye_date" class="form-control pull-right" data-inputmask='"mask": "9999-99-99"' data-mask  >
					 <input type="hidden" name="color" class="form-control pull-right"  >
