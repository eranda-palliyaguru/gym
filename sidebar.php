 ...
 date_default_timezone_set("Asia/Colombo");
  ...
  <aside class="main-sidebar">
	...
	<li>
          ...
          <ul class="treeview-menu">
            <li><a href="sales_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i class="fa fa-circle-o text-yellow"></i> Payment Report</a></li>
			<li><a href="attend_rp.php?d1=<?php echo date("Y-m-d");?>&d2=<?php echo date("Y-m-d");?>"><i class="fa fa-circle-o text-yellow"></i> Attendees Report</a></li>
          </ul>
        </li>
