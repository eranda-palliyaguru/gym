...
<center>
    ...
    <section class="content">
		...
		<div class="box box-danger">
			...
			<div class="box-body">
		<form method="post" action="job_save_w.php">
			
				
			<div class="form-group has-success">
 <label class="control-label" for="inputSuccess"><i class="fa fa-motorcycle"></i>	Vehicle Number</label>
				  
                <input style="width:120px" id="inputSuccess"  type="text" name="vehicle_no"  class="form-control input-lg" data-inputmask='"mask": "***-9999"' data-mask >
                 </div> 
              ...
              <div class="form-group has-warning">
                ...
                <div class="input-group date">
                  ...
                  <select class="form-control " name="name" style="width: 100%;" autofocus >
                  
                  
				  <?php
                $result = $db->prepare("SELECT * FROM washer WHERE type='' ");
