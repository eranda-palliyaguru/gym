...
<link rel="stylesheet" href="datepicker.css"
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
		...
		<div class="box box-danger">
			...
			<div class="box-body">
		<form method="post" action="save_check.php">
 ...
 <label class="control-label" for="inputSuccess"><i class="fa fa-motorcycle"></i>	Vehicle Number</label>
			...
			<div class="col-md-3">
				<label>Check</label>
			  <select class="form-control" name="user" style="width: 100%;" tabindex="1" autofocus >
				 
		<?php  //$invo = $_GET['id'];
         $result = $db->prepare("SELECT * FROM user WHERE position='tech' ORDER by id ASC ");
	...
	<?php	} ?>
			...
			<div class="col-md-3">
			  ...
			  <select class="form-control" name="user1" style="width: 100%;" tabindex="1" autofocus >
	...
	<?php	} ?>
			...
			<label>	AA-xxxx</label>
<input style="width:120px"  type="text" name="vehicle_no2"  class="form-control" data-inputmask='"mask": "AA-9999"' data-mask ></center>
		<?php $result = $db->prepare("SELECT * FROM check_list ORDER by id ASC ");
		$result->bindParam(':userid', $res);
		$result->execute();
		for($i=0; $row = $result->fetch(); $i++){ ?>
		<div class="checkbox">
