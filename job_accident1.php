...
<center>
    ...
    <section class="content">
		...
		<div class="box box-danger">
			...
			<div class="box-body">
		<form method="post" action="job_save_acc.php">
 ...
 <label class="control-label" for="inputSuccess"><i class="fa fa-user"></i>	NIC Number</label>
				  
                <input style="width:120px" id="inputSuccess"  type="text" name="nic"  class="form-control input-lg"  >
                 </div>  
