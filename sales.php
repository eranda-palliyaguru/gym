...
//Find the id of the link that was clicked
    ...
    if (window.event.keyCode==43 ) {
	    ...
	    if (window.event.keyCode==11111146 ){
...
function showResult(str) {
  ...
  xmlhttp.open("GET","sales_sech.php?q="+str+"&invo="+<?php echo $_GET['id']; ?>,true);
  xmlhttp.send();
}
</script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <input name="pro" id="pro" placeholder="Product code"  onChange="fetch_report(document.getElementById('pro').value);this.value='';"class="chzn-select" required autofocus>
	...
	<div class="pull-right" id="livesearch"></div>
...
xmlhttp.open("GET","save_red_note.php?pro="+pro+"&id="+<?php echo $id; ?>+"",true);
xmlhttp.send();
}
